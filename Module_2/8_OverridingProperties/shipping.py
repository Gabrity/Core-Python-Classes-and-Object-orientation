...
class ShippingContainer:
    ...
    # delegate the calculation of volume to this 'abstract' method
    # resembles the usage of template method 
...
class RefigiratedShippingContainer(ShippingContainer):
    ...
    def _calculate_volume(self):
        return (super()._calculate_volume() - RefigiratedShippingContainer.FRIDGE_VOLUME_FT3)
...
container = HeatedRefigiratedShippingContainer.create_empty("YML", 20, celsius = -10)
print(container.volume_ft3)
